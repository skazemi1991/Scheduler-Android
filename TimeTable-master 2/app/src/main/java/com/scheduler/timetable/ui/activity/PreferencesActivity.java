package com.scheduler.timetable.ui.activity;
...
import com.scheduler.timetable.ui.fragments.MyPreferenceFragment;
...
public class PreferencesActivity extends AppCompatActivity {
    ...
    public boolean importDatabase(String ePath) {
        try {
            ...
            if (sd.canWrite()) {
                ...
                String internalDBPath = "data/data/com.scheduler.timetable/databases/";
    ...
    public boolean exportDatabase(String mPath) {
        try {
            ...
            String currentDBPath = Environment.getDataDirectory() + "/data/com.scheduler.timetable/databases/" + mPath;
