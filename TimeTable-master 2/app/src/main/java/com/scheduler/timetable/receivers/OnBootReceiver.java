package com.scheduler.timetable.receivers;
...
public class OnBootReceiver extends BroadcastReceiver {
    ...
    public void onReceive(final Context context, Intent intent) {
        if (intent.getAction().equals(Intent.ACTION_BOOT_COMPLETED) || intent.getAction().equals("com.scheduler.timetable.NOTIFY")) {
