...
import com.scheduler.schedule.ui.activity.PreferencesActivity;
import com.scheduler.schedule.utils.Alarms;
    ...
    public void onCreate(final Bundle savedInstanceState) {
        ...
        notificationTime.setOnPreferenceChangeListener(new Preference.OnPreferenceChangeListener() {
            ...
            public boolean onPreferenceChange(Preference preference, Object o) {
                ...
                if (!o.equals("-1")) {
                    Intent i = new Intent();
                    i.setAction("com.scheduler.schedule.NOTIFY");
            ...
            public boolean onPreferenceClick(Preference preference) {
                if (mActivity.isStoragePermissionGranted(getActivity())) {
                    ...
                    alertDialog.setPositiveButton(getResources().getString(R.string.yes), new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialog, int which) {
                            String backupDBPath = "data/data/com.scheduler.schedule/databases/";
                            final File TimetableDB = new File(backupDBPath + "Timetable");
                            //final File lectureDB = new File(backupDBPath + "lecture.db");
                            if (!(TimetableDB.exists())) {
        ...
        reset.setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() {
            ...
            public boolean onPreferenceClick(Preference preference) {
                ...
                alertDialog.setPositiveButton(getResources().getString(R.string.yes), new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        String resetDBPath = "data/data/com.scheduler.schedule/databases/";
