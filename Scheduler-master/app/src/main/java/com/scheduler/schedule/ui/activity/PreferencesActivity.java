package com.scheduler.schedule.ui.activity;
...
import com.scheduler.schedule.ui.fragments.MyPreferenceFragment;
...
public class PreferencesActivity extends AppCompatActivity {
    ...
    public boolean importDatabase(String ePath) {
        try {
            ...
            if (sd.canWrite()) {
                ...
                String internalDBPath = "data/data/com.scheduler.schedule/databases/";
    ...
    public boolean exportDatabase(String mPath) {
        try {
            ...
            String currentDBPath = Environment.getDataDirectory() + "/data/com.scheduler.schedule/databases/" + mPath;
